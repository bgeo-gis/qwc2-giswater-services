...
class GwGenerateSvg:
    ...
    def _draw_profile(self, arcs, nodes, terrains):
        ...
        self.img_path = f"/qwc-services/qwc2-giswater-services/gw-profiletool-service/tmp/profile_{current_time_ms}.svg"
...
def get_profiletool_ui() -> str:
    return open("./templates/profile_tool.ui").read()
...
def generateProfileSvg(result, params):
    print(result)
